...
public class TelaRegistrarView {
...
//	}
	...
	private void initialize() {
		...
		frame.setTitle("Registro de visualização");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Integer nota = Integer.parseInt(textField_2.getText());
